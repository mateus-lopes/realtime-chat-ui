    ...
    >
      ...
      >
        ...
        <div v-if="!searchQuery" class="py-2">
          <div class="px-4 py-2 text-zinc-400 text-sm font-medium">
            Opções de busca
          </div>

          <button
            @click="handleSearchOption('photos')"
            class="w-full px-4 py-3 text-left hover:bg-zinc-800 transition-colors duration-150 flex items-center gap-3"
          >
            <div
            ...
            <div>
              <div class="text-zinc-200 font-medium">Fotos</div>
              <div class="text-zinc-400 text-sm">Buscar por imagens</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <div class="text-zinc-200 font-medium">Vídeos</div>
              <div class="text-zinc-400 text-sm">Buscar por vídeos</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <div class="text-zinc-200 font-medium">Documentos</div>
              <div class="text-zinc-400 text-sm">Buscar por arquivos</div>
            </div>
          </button>
          ...
          >
            ...
            <div>
              <div class="text-zinc-200 font-medium">Links</div>
              <div class="text-zinc-400 text-sm">Buscar por links</div>
            </div>
          </button>
        </div>
        ...
        <div v-else-if="searchResults.length > 0" class="py-2">
          ...
          <div
            ...
            class="px-4 py-3 hover:bg-zinc-800 transition-colors duration-150 cursor-pointer border-l-2 border-transparent hover:border-blue-500"
          >
            <div class="flex items-start gap-3">
              <div
                class="w-8 h-8 bg-zinc-600 rounded-full flex items-center justify-center flex-shrink-0"
              >
                <svg
        ...
        <div v-else-if="searchQuery" class="py-8 text-center">
          <div class="text-zinc-400 text-sm">Nenhuma mensagem encontrada</div>
